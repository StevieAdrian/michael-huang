...
export const notarisArticles: Article[] = [
  ...
  {
    id: "10",
    title: "Prosedur Pembuatan Surat Keterangan Waris dan Akta Kematian di Notaris",
    excerpt:
      "Ketika anggota keluarga meninggal, ada dokumen hukum yang perlu segera disiapkan agar pengurusan hak waris tidak terhambat. Pahami prosedur lengkapnya.",
    date: "8 September 2026",
    category: "Panduan",
    slug: "surat-keterangan-waris-akta-kematian",
  },
  {
    id: "11",
    title: "Akta RUPS: Kapan Diperlukan dan Apa Saja Isinya?",
    excerpt:
      "Setiap keputusan penting perusahaan yang diambil dalam Rapat Umum Pemegang Saham wajib dituangkan dalam akta notaris. Pelajari fungsi dan syarat legalnya.",
    date: "8 September 2026",
    category: "Bisnis",
...
export const notarisArticleDetails: Record<string, ArticleDetail> = {
  ...
  "surat-keterangan-waris-akta-kematian": {
    slug: "surat-keterangan-waris-akta-kematian",
    category: "Panduan",
    readTime: "7 menit",
    date: "8 September 2026",
    title: "Prosedur Pembuatan Surat Keterangan Waris dan Akta Kematian di Notaris",
    subtitle:
      "Surat keterangan waris dan akta kematian adalah dua dokumen dasar yang menentukan kelancaran pengurusan hak waris. Pahami perbedaan dan cara mengurusnya.",
    author: {
      name: "Kantor Notaris Dr. Michael, S.H., S.T., M.Kn.",
      role: "Tim Redaksi Notaris",
    },
    content: [
      {
        type: "paragraph",
        text: "Ketika seseorang meninggal dunia, keluarga yang ditinggalkan sering kali tidak mengetahui dokumen hukum apa yang perlu segera disiapkan. Dua dokumen paling mendasar dalam proses pengurusan hak waris adalah Akta Kematian dari Dinas Kependudukan dan Catatan Sipil (Disdukcapil) serta Surat Keterangan Waris (SKW) yang dapat dibuat di kantor notaris.",
      },
      {
        type: "heading",
        text: "Perbedaan Akta Kematian dan Surat Keterangan Waris",
      },
      {
        type: "paragraph",
        text: "Akta kematian adalah dokumen resmi yang mencatat peristiwa kematian seseorang secara administratif kependudukan. Sementara itu, surat keterangan waris adalah dokumen yang menerangkan siapa saja ahli waris yang berhak atas harta peninggalan almarhum. SKW yang dibuat di hadapan notaris memiliki kekuatan hukum lebih kuat dibanding yang hanya dilegalisasi oleh lurah atau camat.",
      },
      {
        type: "heading",
        text: "Syarat Pembuatan Surat Keterangan Waris di Notaris",
      },
      {
        type: "list",
        items: [
          "Fotokopi KTP dan Kartu Keluarga almarhum serta seluruh ahli waris.",
          "Akta kematian yang telah diterbitkan oleh Disdukcapil.",
          "Akta nikah almarhum (jika sudah menikah).",
          "Akta kelahiran seluruh ahli waris yang disebutkan.",
          "Surat pernyataan ahli waris yang ditandatangani seluruh pihak di hadapan notaris.",
        ],
      },
      {
        type: "quote",
        text: "Dokumen waris yang tidak disiapkan tepat waktu sering mempersulit proses klaim asuransi, pencairan deposito, atau balik nama properti peninggalan.",
      },
      {
        type: "heading",
        text: "Mengapa Sebaiknya Melalui Notaris?",
      },
      {
        type: "paragraph",
        text: "SKW yang dibuat di notaris memiliki status sebagai akta autentik, sehingga memiliki kekuatan pembuktian sempurna di hadapan hukum. Ini sangat penting ketika ahli waris perlu mengurus pencairan rekening bank, klaim asuransi jiwa, balik nama sertifikat tanah, atau pengurusan saham perusahaan almarhum.",
      },
      {
        type: "paragraph",
        text: "Segera urus dokumen waris setelah masa berkabung, idealnya dalam 3 bulan sejak kematian, agar proses hukum selanjutnya tidak mengalami hambatan administrasi yang tidak perlu.",
      },
    ],
    tags: ["Waris", "Akta Kematian", "Notaris", "Panduan"],
  },
  "akta-rups-notaris-fungsi": {
    slug: "akta-rups-notaris-fungsi",
    category: "Bisnis",
    readTime: "6 menit",
    date: "8 September 2026",
    title: "Akta RUPS: Kapan Diperlukan dan Apa Saja Isinya?",
    subtitle:
      "Rapat Umum Pemegang Saham yang tidak dituangkan dalam akta notaris berisiko menghasilkan keputusan yang tidak sah secara hukum. Pahami kapan dan bagaimana akta RUPS harus dibuat.",
    author: {
      name: "Kantor Notaris Dr. Michael, S.H., S.T., M.Kn.",
      role: "Tim Redaksi Notaris",
    },
    content: [
      {
        type: "paragraph",
        text: "Rapat Umum Pemegang Saham (RUPS) adalah forum pengambilan keputusan tertinggi dalam sebuah Perseroan Terbatas (PT). Keputusan yang diambil dalam RUPS bersifat mengikat dan dapat berdampak hukum yang luas, mulai dari perubahan direksi hingga perubahan anggaran dasar. Oleh karena itu, risalah RUPS sering wajib dituangkan dalam Akta Notaris.",
      },
      {
        type: "heading",
        text: "Kapan Akta RUPS Wajib Dibuat di Notaris?",
      },
      {
        type: "list",
        items: [
          "Perubahan anggaran dasar perusahaan (nama, modal, kegiatan usaha).",
          "Pengangkatan atau pemberhentian anggota direksi dan dewan komisaris.",
          "Penambahan atau pengurangan modal dasar, modal ditempatkan, dan modal disetor.",
          "Merger, akuisisi, konsolidasi, atau pembubaran perusahaan.",
          "Perubahan status perusahaan (misalnya dari PT Tertutup menjadi PT Terbuka).",
        ],
      },
      {
        type: "heading",
        text: "Isi Minimal Akta RUPS yang Sah",
      },
      {
        type: "paragraph",
        text: "Akta RUPS yang dibuat di hadapan notaris harus memuat: identitas para pihak yang hadir, agenda rapat, kuorum dan persentase suara yang dicapai, keputusan-keputusan yang diambil secara resmi, serta tanggal dan tempat pelaksanaan RUPS. Notaris berperan sebagai penyaksi dan pencatat yang netral agar akta memiliki kekuatan autentik.",
      },
      {
        type: "quote",
        text: "RUPS tanpa akta notaris bisa disengketakan. Akta autentik adalah bukti terkuat bahwa keputusan perusahaan telah diambil secara sah.",
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "Setelah RUPS berlangsung, risalah rapat (minutes of meeting) diserahkan kepada notaris untuk dituangkan dalam akta. Untuk perubahan yang perlu persetujuan Kementerian Hukum dan HAM, notaris akan mengurus pemberitahuan atau permohonan persetujuan secara elektronik melalui sistem AHU Online. Proses ini umumnya memakan waktu 7–14 hari kerja tergantung jenis perubahannya.",
      },
      {
        type: "paragraph",
        text: "Jika Anda akan mengadakan RUPS dalam waktu dekat, libatkan notaris sejak persiapan untuk memastikan tata cara dan dokumentasi rapat sesuai ketentuan UU Perseroan Terbatas No. 40 Tahun 2007.",
      },
    ],
