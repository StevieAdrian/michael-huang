    ...
    <div className="pb-24 pt-24 md:pt-28">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <Link href="/musik-production-michael" className="hover:text-gold transition-colors">
            Musik
          </Link>
          <ChevronRight className="w-3 h-3" />
        ...
        <div className="mt-10 pt-8 border-t border-border/50">
          ...
          <div className="bg-card border border-border rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
            ...
            <div className="flex-1">
              <p className="font-bold text-base mb-1">Punya proyek audio yang mau diproduksi?</p>
              <p className="text-muted-foreground text-sm">
                Tim musik kami siap bantu dari konsep sampai rilisan final.
              </p>
            </div>
            <a
        ...
        <div className="mt-8">
          <Link href="/musik-production-michael">
            <span className="inline-flex items-center gap-2 text-sm font-semibold text-muted-foreground hover:text-gold transition-colors">
              <ArrowLeft className="w-4 h-4" /> Kembali ke Musik
            </span>
          </Link>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {relatedArticles.map((item) => (
              <Link key={item.id} href={`/musik-production-michael/artikel/${item.slug}`}>
