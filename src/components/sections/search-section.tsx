      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
        ...
        <div className="relative group max-w-2xl mx-auto">
          ...
          <div className="relative flex items-center bg-background border border-border/50 rounded-2xl p-2 shadow-xl focus-within:border-gold/50 transition-colors">
            ...
            <input
              type="text"
              placeholder="Cari pengacara, kamar, menu, jadwal ibadah..."
              className="w-full bg-transparent border-none text-foreground px-3 py-3 focus:outline-none focus:ring-0 text-sm md:text-base placeholder:text-muted-foreground/50"
            />
            <button className="px-5 md:px-6 py-3 bg-foreground text-background hover:bg-gold hover:text-primary-foreground font-semibold rounded-xl transition-colors duration-300 text-sm whitespace-nowrap">
              Cari
            </button>
          </div>
        </div>
