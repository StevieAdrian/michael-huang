                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest border border-border/50 px-2 py-0.5 rounded-full">{service.tag || "Service"}</span>
                    </div>
